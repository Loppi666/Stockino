...
public partial class App : Application
{
    ...
    protected async override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        var databasePath = Path.Combine(ApplicationData.Current.LocalFolder.Path, "Database.db");
        ...
        routes.Register(
            new RouteMap("", View: views.FindByViewModel<ShellModel>(),
                ...
                [
                    ...
                    new("Transactions",  View: views.FindByViewModel<TransactionsModel>()),
                    new("TransactionDetail", View: views.FindByViewModel<TransactionDetailModel>())
                ]
            ));
    }
