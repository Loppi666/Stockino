...
namespace Stockino3.Presentation.Converters
{
    public class EVToEBITDAConverter : IValueConverter
    {
        ...
        {
            if (decimal.TryParse(evEbitda, NumberStyles.Any, CultureInfo.InvariantCulture, out decimal value))
            {
                if (value < 8)
                {
