...
namespace Stockino3.Presentation.Converters
{
    public class PEGRatioConverter : IValueConverter
    {
        ...
        {
            if (decimal.TryParse(peg, NumberStyles.Any, CultureInfo.InvariantCulture, out var value))
            {
                if (value < 1)
