...
namespace Stockino3.Presentation.Converters
{
    public class DividendYieldConverter : IValueConverter
    {
        ...
        {
            if (decimal.TryParse(yield, NumberStyles.Any, CultureInfo.InvariantCulture, out decimal value))
            {
                if (value > 6)
                {
